...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.spark.branding.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.spark.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.spark.build.variant";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "spark.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "spark.updater.uri";
